...
// RAK4631 has only two LEDs. Alias LED_RED to LED_GREEN so code that
// references LED_RED still compiles — the main.cpp LED renderer uses the
// BOARD_RAK4631 build flag to switch to a 2-LED scheme that never relies
// on a real red pin.
